...
public class HouseGroupHub : Hub
{
    ...
    public async Task JoinHouse(string houseName)
    {
        if (!GroupsJoined.Contains(Context.ConnectionId + ":" + houseName))
        {
            ...
            await Clients.Others.SendAsync("newHouseJoined", houseName);
    ...
    public async Task LeaveHouse(string houseName)
    {
        if (GroupsJoined.Contains(Context.ConnectionId + ":" + houseName))
        {
            ...
            await Clients.Others.SendAsync("newHouseLeft", houseName);
    ...
    {
        await Clients.OthersInGroup(houseName).SendAsync("triggerNotification", houseName);
    }
}
